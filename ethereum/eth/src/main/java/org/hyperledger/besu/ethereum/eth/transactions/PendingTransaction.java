...
import static org.hyperledger.besu.ethereum.eth.transactions.PendingTransaction.MemorySize.DEPOSIT_SIZE;
...
import static org.hyperledger.besu.ethereum.eth.transactions.PendingTransaction.MemorySize.IS_SYSTEM_TX_SIZE;
...
import static org.hyperledger.besu.ethereum.eth.transactions.PendingTransaction.MemorySize.MINT_SIZE;
...
import static org.hyperledger.besu.ethereum.eth.transactions.PendingTransaction.MemorySize.SOURCE_HASH_SIZE;
...
public abstract class PendingTransaction
  ...
  public interface MemorySize {
    ...
    int DEPOSIT_SIZE = 872;
    int SOURCE_HASH_SIZE = 32;
    int IS_SYSTEM_TX_SIZE = 1;
    int MINT_SIZE = 32;
  }
}
